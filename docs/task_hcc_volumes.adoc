...
+
Vedere informazioni su link:concept_hci_volume_access_groups.html["gruppi di accesso ai volumi"].
...
+
Vedere informazioni su link:concept_cg_hci_accounts.html["Account utente NetApp HCI"].
...
+
Consultare le informazioni relative a https://docs.netapp.com/sfe-122/topic/com.netapp.doc.sfe-ug/GUID-EBCB1031-1B2D-472C-92E3-E0CB52B4156C.html["Gruppi di accesso, iniziatori e metodi di autenticazione CHAP"^] nella _Guida dell'utente di NetApp Element_.
...
+
Vedere informazioni su link:concept_hci_performance#qos-performance.html["Policy di performance e QoS"].

+
Consultare le informazioni relative a https://docs.netapp.com/sfe-122/topic/com.netapp.doc.sfe-ug/GUID-C90C0C1C-AE38-46FA-A854-BB425B55BEF4.html["Policy sulla qualità del servizio"^] nella _Guida dell'utente di NetApp Element_.
...
* https://docs.netapp.com/sfe-122/index.jsp["Centro di documentazione NetApp SolidFire ed Element"^]
